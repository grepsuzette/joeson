					...
					o(Named("UNIT", rules(
						...
						o(Named("LABELED", rules(
							...
							o(Named("PRIMARY", rules(
								...
								o(s(st("'"), p(s(n(st("'")), c(r("ESC1"), r("."))), nil), st("'")), func(it Ast) Ast { return newStr(string(it.(*NativeArray).Concat())) }),
								o(s(st("/"), p(s(n(st("/")), c(r("ESC2"), r("."))), nil), st("/")), func(it Ast) Ast { return newRegexFromString(string(it.(*NativeArray).Concat())) }),
								o(s(st("["), p(s(n(st("]")), c(r("ESC2"), r("."))), nil), st("]")), func(it Ast) Ast { return newRegexFromString("[" + string(it.(*NativeArray).Concat()) + "]") }),
							))),
						))),
					))),
